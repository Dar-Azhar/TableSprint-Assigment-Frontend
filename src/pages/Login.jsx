...
const Login = () => {
  ...
  return (
    <div
      className={`relative sm:h-screen bg-contain bg-center bg-no-repeat`}
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="absolute top-5 right-5  left-4 xs:left-7 sm:top-[8rem] md:top-8 md:left-56 xl:left-80 xl:top-8 sm:left-36 bg-white shadow-lg rounded-md p-8 max-w-72  w-full  sm:max-w-[32rem] sm-plus:max-w-96 xs:max-w-80 md:max-w-96 ">
            ...
            <div className=" flex-col sm:flex text-center mt-4">
